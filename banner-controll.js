var websitePrivacyPage = "https://givetojcenter.dk/content/3-handelsbetingelser";
var unknownCookieText = ["Ukendt", "Disse cookieoplysninger er ukendte"];

var categoryText = ["Nødvendige", "Præferencer", "Statistik", "Marketing", "Ukategoriseret"];

var learnMoreText = "Læs mere om udbyderen";

var topSectionText = ["Samtykke", "Detaljer", "Om"];

var firstSectionText = "Vi bruger cookies til at personalisere indhold og annoncer, tilbyde funktioner til sociale medier og analysere vores trafik. Vi deler også oplysninger om din brug af vores website med vores partnere inden for sociale medier, annoncering og analyse, som kan kombinere dem med andre oplysninger, du har givet dem, eller som de har indsamlet fra din brug af deres tjenester.";
var thirdSectionText = "Cookies er små tekstfiler, der bruges af websites til at forbedre brugeroplevelsen. Loven tillader, at vi gemmer cookies på din enhed, hvis de er strengt nødvendige for driften af dette website. For alle andre typer cookies har vi brug for dit samtykke. Det betyder, at cookies, der klassificeres som nødvendige, håndteres i henhold til GDPR artikel 6(1)(f). Alle andre cookies, f.eks. i kategorierne Præferencer og Marketing, håndteres i henhold til GDPR artikel 6(1)(a). Dette website bruger forskellige typer af cookies. Nogle cookies sættes af tredjepartstjenester, der vises på vores sider.";

var bannerButtonsTexts = ["Accepter", "Afvis", "Tilpas", "Gem"];

var categoryDescriptionsText = {
	Necessary: {
		description: "Nødvendige cookies gør websitet anvendeligt ved at aktivere grundlæggende funktioner som navigation og adgang til sikre områder. Uden disse cookies kan websitet ikke fungere korrekt.",
	},
	Preferences: {
		description: "Præferencecookies gør det muligt for et website at huske oplysninger, der ændrer den måde, websitet opfører sig eller ser ud.",
	},
	Statistics: {
		description: "Statistikcookies hjælper websiteejere med at forstå, hvordan besøgende interagerer med websitet ved at indsamle og rapportere oplysninger anonymt.",
	},
	Marketing: {
		description: "Marketingcookies bruges til at spore besøgende på tværs af websites med det formål at vise annoncer, der er relevante og engagerende for den enkelte bruger.",
	},
	Unclassified: {
		description: "Ukategoriserede cookies er cookies, som vi i øjeblikket er ved at klassificere sammen med udbyderne af de enkelte cookies.",
	},
};
...
window.addEventListener("load", function() {
	...
	function createMainElements() {
        ...
        <svg width="50px" fill="#000000" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M21.598 11.064a1.006 1.006 0 0 0-.854-.172A2.938 2.938 0 0 1 20 11c-1.654 0-3-1.346-3.003-2.938.005-.034.016-.134.017-.168a.998.998 0 0 0-1.254-1.006A3.002 3.002 0 0 1 15 7c-1.654 0-3-1.346-3-3 0-.217.031-.444.099-.716a1 1 0 0 0-1.067-1.236A9.956 9.956 0 0 0 2 12c0 5.514 4.486 10 10 10s10-4.486 10-10c0-.049-.003-.097-.007-.160a1.004 1.004 0 0 0-.395-.776zM8.5 6a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm-2 8a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm3 4a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm2.5-6.5a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0zm3.5 6.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"></path></g></svg>
        `
			...
			if (totalCookies === 0) {
				categoryHTML += `
                    <div class="NoCookieWarning">
                        <span>Ingen cookies at vise</span>
                    </div>`;
			} else {
		...
		if (getSecondBanner) {
			...
			function showSecondBanner() {
                ...
                <div class="doubleCheckPopUp">
                    <h1 class="cookieHeadline">Vi har bemærket, at du har afvist cookies. Det respekterer vi, men vær opmærksom på, at afvisning kan påvirke din oplevelse. Visse funktioner, såsom personaliseret indhold og specifik funktionalitet, kan muligvis ikke fungere som tilsigtet. For den bedste oplevelse anbefaler vi, at du genovervejer dit valg. Du kan til enhver tid justere dine præferencer i indstillingerne eller acceptere cookies igen.</h1>
                    <div class="secondBannerBtnWrapper">
                        <button class="secondBannerBtn secondBannerAccept active">Accepter</button>
                        <button class="secondBannerBtn secondBannerDeclined declined">Afvis</button>
                    </div>
                </div>
                `;
